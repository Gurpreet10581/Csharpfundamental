...
namespace _01_TypesandVariables
{
    ...
    {
        [TestMethod]
        public void Strings()// Creating string and calling it 
        {
            string thisisDeclaration;
            string declared;
            declared = "This is intialized";
            string declarationAndIntialization = "This is both declaring and Initializing";
            ...
            //Composite
            string CompostieFullName = string.Format("{0} {1}", firstName, lastName);
        ...
        public void Collections()
        {
            ...
            Stack<string> lastInFristOut = new Stack<string>();
        }
        [TestMethod]
        public void Classes()
        {
